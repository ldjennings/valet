...
**Forked again from the [repository](https://github.com/liespace/pyReedsShepp) of [Gabel Liemann](https://github.com/liespace).**
Modified to work with python 3.12, added .pyi file to allow intellisense in vscode.
